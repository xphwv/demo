...
import com.xphwv.geolocal.map.entity.Point;
...
public class CoordinateConversion {
	...
	public static void main(String[] args){
		Point point = bd_google_encrypt(39.967542,116.793561);
		NumberFormat nFormat = NumberFormat.getNumberInstance();
		nFormat.setMaximumFractionDigits(6);// 设置小数点后面位数为6
		System.out.println(nFormat.format(point.getLng())+","+nFormat.format(point.getLat()));
	}
