...
public class GaoDeMap {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void handleProvince(List<Map> provinceList) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static void handleCity(String provinceName, List<Map> cityList) {
	...
	public static void handleArea(String provinceName, String cityName, List<Map> areaList) {
