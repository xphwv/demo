...
public class Client implements Runnable {
	...
	private void initWords() throws InterruptedException {
		msg = new ArrayBlockingQueue<String>(5);
		msg.put("hi");
		msg.put("who");
		msg.put("what");
		msg.put("where");
			...
			while (true) {
				while (ite.hasNext()) {
					...
					if (key.isConnectable()) {
						...
						channel.write(CharsetHelper.encode(CharBuffer.wrap(clickMs + getMsg())));
						sleep();
					}
				}
				try {
